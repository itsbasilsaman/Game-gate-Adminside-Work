...
const initialState: UserState = {
  ...
  isLoggedGGAdmin: localStorage.getItem("isLogged")
    ...
    builder
      ...
      .addCase(userLanguageChange.fulfilled, (state, { payload }) => {
        ...
        localStorage.setItem(
          "userLanguage",
          JSON.stringify(state.userLanguage)
        );
      })
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(loginAdmin.fulfilled, (state, { payload }) => {
        ...
        state.isLoggedGGAdmin = true;
        localStorage.setItem("isLoggedGGAdmin", JSON.stringify(state.isLoggedGGAdmin));
