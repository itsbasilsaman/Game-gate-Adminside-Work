  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0  adminlogin-background  " >
        <div className="  relative inset-0 flex justify-center items-start pt-[60px]">
      ...
      {/* Form Container */}
      <div
        className="relative z-10 flex flex-col rounded-[22px] shadow-md   items-center border border-black-0 bg-white px-[40px] py-[65px] w-full max-w-md  admin-login-box  "
        style={{
        //  backgroundImage:url(${BgImg})
        }}
      >
